...
<div class="box box-primary">
  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
	  ...
	  <div class="form-group">
        <label for="exampleInputPassword1">№ of Peoples</label>
		<span id="sprytf_ucount">
        <input type="text" name="ucount" class="form-control input-sm" placeholder="№ of peoples" >
		<span class="textfieldRequiredMsg">№ of peoples is required.</span>
